...
PHASES: dict[str, list[tuple[str, Callable[[list[Fill]], None]]]] = {
    ...
    "landmarks": [
        ...
        ("taiye_boat_3d", taiye_boat_3d.build_taiye_boat_3d),
        ("jieshi_pailou_3d", jieshi_pailou_3d.build_jieshi_pailou_3d),
        ...
        ("danfeng_plaza_3d", danfeng_plaza_3d.build_danfeng_plaza_3d),
        ("street_traffic_3d", street_traffic_3d.build_street_traffic_3d),
        ("hanshi_qingming_3d", hanshi_qingming_3d.build_hanshi_qingming_3d),
        ("food_street_3d", food_street_3d.build_food_street_3d),
        ("palace_hall_v2_3d", palace_hall_v2_3d.build_palace_hall_v2_3d),
        ("temple_buddha_3d", temple_buddha_3d.build_temple_buddha_3d),
        ("ximingsi_3d", ximingsi_3d.build_ximingsi_3d),
        ("neiyuan_3d", neiyuan_3d.build_neiyuan_3d),
        ("lantern_wheel_3d", lantern_wheel_3d.build_lantern_wheel_3d),
        ("official_interior_3d", official_interior_3d.build_official_interior_3d),
        ("city_roof_beasts_3d", city_roof_beasts_3d.build_city_roof_beasts_3d),
    ],
    "details": [
